...
class DepartmentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'coordinator_id' => ['type' => 'integer', 'length' => 10, 'default' => null, 'null' => false, 'comment' => null, 'precision' => null, 'unsigned' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'departments_name' => ['type' => 'unique', 'columns' => ['name'], 'length' => []],
            'departments_coordinator_id' => ['type' => 'unique', 'columns' => ['coordinator_id'], 'length' => []],
            'departments_coordinator_id_fkey' => ['type' => 'foreign', 'columns' => ['coordinator_id'], 'references' => ['users', 'id'], 'update' => 'cascade', 'delete' => 'noAction', 'length' => []],
        ],
    ];
