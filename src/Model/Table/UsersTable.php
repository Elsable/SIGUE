...
class UsersTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->hasMany('Roles')->setForeignKey('user_id');
    }
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->scalar('motherlastname')
            ->maxLength('motherlastname', 100)
            ->allowEmptyString('motherlastname');
