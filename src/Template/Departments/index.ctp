    ...
    <table class="table table-hover table-responsive ">
        ...
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('coordinator_id') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $department->has('user') ? $this->Html->link($department->user->username, ['controller' => 'Users', 'action' => 'view', $department->user->id]) : '' ?></td>
